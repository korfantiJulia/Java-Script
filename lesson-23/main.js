...
class CalorieCalculator {
  ...
  addProduct(fruit, cal) {
    this.store.set(fruit, cal);
  }

  getProductCalories(fruit) {
    if (this.store.has(fruit)) {
      return this.store.get(fruit);
    }
    return "Product not found";
  }

  removeProduct(fruit) {
    this.store.delete(fruit);
  }
}
